...
<html>
    ...
    <?php $this -> load -> view("www/includes/header.php")?>
        ...
        <div id="main" class="">    
			<div class="inner">
				<div class="games_title"><h2>AMEBA</h2></div>
                <ul class="nav nav-pills nav-fill games_nav" role="tablist">
                  ...
                  <li class="pill-kind nav-item">
                  	<a class="nav-link <?php if(@$_GET['kind']==$row["num"]) echo ' active'?>"  href="<?php echo site_url("Slot/ameba?kind=".$row["num"])?>"><?php echo $row["kind"]?></a>
                  </li>
                  <?php endforeach;?>
                  <?php endif;?>
                </ul>
                  <div class="row GameBox">
                    <div class="col-md-12 row">
                        ...
                        <div class="col-md-3 col-6">
                          <div class="Game">                                                   
                                 <div class="games_logo ameba"><img src="<?php echo UPLOADS_URL?>/games/<?php echo $row["pic1"] ?>" class="img-fluid"/></div>

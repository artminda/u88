...
<div class="games_title"><h2>QT老虎機</h2></div>
                <ul class="nav nav-pills nav-fill games_nav" role="tablist">
                  ...
                  <li class="pill-kind nav-item">
                  	<a class="nav-link <?php if(@$_GET['kind']==$row["num"]) echo ' active'?>"  href="<?php echo site_url("Slot/qt?kind=".$row["num"])?>"><?php echo $row["kind"]?></a>
                  </li>
                  <?php endforeach;?>
                  <?php endif;?>
                </ul>
